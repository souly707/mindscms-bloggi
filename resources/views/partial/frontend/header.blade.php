            ...
            <div class="col-lg-8 d-none d-lg-block">
                <nav class="mainmenu__nav">
                    <ul class="meninmenu d-flex justify-content-start">
                        ...
                        <li class="drop with--one--item"><a href="{{ route('posts.show', 'about-us') }}">About Us</a>
                        </li>
                        <li class="drop with--one--item"><a href="{{ route('posts.show', 'our-vision') }}">Our
                                Vision</a></li>
                                    ...
                                    <div class="switcher-options">
                                        <div class="switcher-currency-trigger">
                                            <div class="setting__menu">
                                                ...
                                                @else
                                                <span><a href="{{ route('frontend.dashboard') }}">My
                                                        Dashboard</a></span>
