...
<div class="col-lg-9 col-12">
    <div class="blog-details content">
                ...
                <div class="post_header">
                    ...
                    <div class="blog-date-categori">
                        <ul>
                            ...
                            <li><a href="{{ route('frontend.author.posts', $post->user->username) }}"
        ...
        <div class="comment_respond">
            ...
            <form class="comment__form" action="{{ route('posts.add.comment', $post->slug) }}" method="POST">
                @csrf
                <p>Your email address will not be published.Required fields are marked </p>

                <div class="input__box">
                    <textarea name="comment" valeu="{{ old('comment') }}" placeholder="Your comment here"></textarea>
                    @error('comment')
